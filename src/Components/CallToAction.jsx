const CallToAction = () => {
    return (
        <div>
            <section className="py-6 dark:bg-gray-100 dark:text-gray-900 flex justify-center items-center  mt-40">
                <div
                    className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                    <div className="flex flex-col justify-center lg:text-left">
                        <p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-[#23BE0A]">Download Our App</p>
                        <h1 className="py-2 text-3xl font-medium leading-tight title-font">Download our mobile app and enjoy our latest Books. <br /> You can download our app from Google Play Store and Apple Store</h1>
                    </div>
                    <div
                        ...
                        <button
                            className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-[#23BE0A] dark:text-gray-50">
                            <svg
                        ...
                        <button
                            className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-[#23BE0A] dark:text-gray-50">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 50 50"
                                className="fill-current w-7 h-7 dark:text-gray-50">
